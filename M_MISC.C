...
default_t   defaults[] =
{
    ...
    {"music_volume",&musicVolume, 13},
    {"show_talk",&dialogshowtext, 0},
    {"voice_volume",&voiceVolume, 15},
    ...
    {"key_useHealth",&key_usehealth, SC_KEY_H, 1},
    {"key_jump",&key_jump, SC_KEY_A, 1},
    {"key_invquery",&key_invquery, SC_KEY_Q, 1},
    {"key_mission",&key_mission, SC_KEY_W, 1},
    {"key_invPop",&key_invpop, SC_KEY_Z, 1},
    {"key_invKey",&key_invkey, SC_KEY_K, 1},
    {"key_invHome",&key_invhome, SC_HOME, 1},
    {"key_invEnd",&key_invend, SC_END, 1},
    {"key_invLeft",&key_invleft, SC_INSERT, 1},
    {"key_invRight",&key_invright, SC_DELETE, 1},
    {"key_invUse",&key_invuse, SC_ENTER, 1},
    {"key_invDrop",&key_invdrop, SC_BACKSPACE, 1},
    {"key_lookUp",&key_lookup, SC_PAGEUP, 1},
    {"key_lookDown",&key_lookdown, SC_PAGEDOWN, 1},
    ...
    {"back_flat",(int *)&back_flat, (int)"F_PAVE01" },
    {"nickname",(int *)&nickname, (int)"" },
...
void M_ScreenShot (void)
{
    ...
    if (i == 100)
    {
        players[consoleplayer].message = "Already have 100 shots...";
        return;
    }
    // save the pcx file
    ...
    players[consoleplayer].message = "STRIFE  by Rogue entertainment";
}
